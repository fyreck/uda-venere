        ...
        <section class="eventi eventi-prenotati">
            ...
            <section class="eventi eventi-futuri" id="eventi-futuri">    
                ...
                <div class="cards-wrapper" style="margin-left: <?= $loggato ? '64px' : '0px' ?>">
                    <div class="cards">
                        <?php
                            $sql = "SELECT E.IDEvento, E.Titolo, E.DataEvento, E.OraEvento, E.Luogo, C.Nome as 'NomeCategoria', E.Descrizione, E.Immagine, E.Prezzo, E.NumeroPosti, A.Nome, A.Cognome FROM EVENTO as E, ARTISTA as A, CATEGORIAINTERESSE as C, PARTECIPAZIONE as P, UTENTE as U, PRENOTAZIONE as PR WHERE E.IDEvento = P.Evento AND A.IDArtista = P.Artista AND C.IDCategoria = E.Categoria AND U.NomeUtente = ? AND E.IDEvento = PR.Evento AND E.DataEvento > ? GROUP BY E.IDEvento";
